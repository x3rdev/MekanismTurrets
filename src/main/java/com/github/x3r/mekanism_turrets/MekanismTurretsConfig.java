...
public class MekanismTurretsConfig {
    ...
    static  {
        ...
        LaserTurretTier.BASIC.setConfigReference(basicLaserTurretCooldown.get(), basicLaserTurretDamage.get(), basicLaserTurretEnergyCapacity.get(), basicLaserTurretRange.get());
